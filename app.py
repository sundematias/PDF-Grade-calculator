...
if uploaded_file:
    try:
        ...
        st.markdown("An error occured. Make sure you have uploaded the correct PDF format. There could also be some edge case un your PDF that is not handled yet. In that case: Contact gradecalculatorntnu@gmail.com for help or submit a pull request:) .")
